...
#define STUDENT_NUMBER		"Brent"
#define STUDENT_FIRSTNAME	"Brent"
#define STUDENT_FAMILYNAME	"Needham"

#define IP_ADDRESS_SERVER	"164.11.80.75"
//#define IP_ADDRESS_SERVER "164.11.174.44"
//#define IP_ADDRESS_SERVER "164.11.157.21"
...
void tactics()
{
	...
	set_new_flag(ship[0].X + ship[0].Y + 900);
	if(ally[0].Health < 5 && friendInRange)
	{
